...
export class InitialSchema1598578727466 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `customer` (`customer_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, `first_name` varchar(75) NOT NULL, `last_name` varchar(75) NOT NULL, `is_active` tinyint(1) UNSIGNED NOT NULL DEFAULT 1, `created_at` datetime NOT NULL, `updated_at` datetime NOT NULL, PRIMARY KEY (`customer_id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `account` (`account_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, `number` varchar(50) NOT NULL, `balance` decimal(10,2) NOT NULL, `is_locked` tinyint(1) UNSIGNED NOT NULL DEFAULT 0, `customer_id` bigint UNSIGNED NOT NULL, `created_at` datetime NOT NULL, `updated_at` datetime NOT NULL, UNIQUE INDEX `IDX_51a4a0db7e5c7bc465ffc8722b` (`number`), PRIMARY KEY (`account_id`)) ENGINE=InnoDB");
